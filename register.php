...
<body>
	...
	Political Side:</br>
	<input type="radio" name="side" <?php if (isset($side) && $side=="right") echo "checked";?>  value="right">Right</br>
	<input type="radio" name="side" <?php if (isset($side) && $side=="left") echo "checked";?>  value="left">Left</br>
